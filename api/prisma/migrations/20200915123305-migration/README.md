# Migration `20200915123305-migration`

This migration has been generated by A. David Thyresson at 9/15/2020, 8:33:05 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TYPE "public"."DocumentType" AS ENUM ('ARTICLE', 'TWEET')
